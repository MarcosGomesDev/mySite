...
export const SectionHero = () => {
  ...
  return (
    <Element name='home' className='element'>
      <section className='flex items-center w-full h-screen pt-4'>
        <div className='w-full container mx-auto flex justify-center lg:justify-around items-center flex-col lg:flex-row text-center'>
          <div className='mb-6 lg:mb-0'>
            <h3 className='text-2xl md:text-4xl text-blue dark:text-gray-100 font-bold leading-tight'>
              Olá 👋, <br /> Meu nome é <br />{" "}
              <span className={`${activeStyle}`}> Marcos Gomes</span> <br />{" "}
              Desenvolvedor Fullstack
            </h3>
          </div>
          <div className='rounded-full flex items-center justify-center w-72  bg-gradient-b-border-gradient h-72 mt-8 md:mt-0'>
